...
const MainPageBodyFour = () => {
  ...
  useEffect(() => {
    const fetchProductsBeauty = async (data) => {
      const response = await fetch('http://localhost:3001/getproductbeauty', {
        method: "GET"
      });
  ...
  return (
    <>
      <Text px={5} py={5} fontSize="5xl" fontFamily="adineue PRO Bold" bg="#F3EEEA">Our Popular Care Products</Text>
      <Flex
...
export default MainPageBodyFour;